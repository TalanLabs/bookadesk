...
export const uploadFile = async (
  ...
  try {
    axios.post(`${apiUrl}/offices/${officeId}/floors/${floorId}/plan`, formData, {
      headers: {
...
export const getFloorPlan = async (floorId: string, officeId: string) : Promise<any> => {
  try {
   const res = await axios.get(`${apiUrl}/offices/${officeId}/floors/${floorId}/plan`)
   return res.data
  } catch (e) {
