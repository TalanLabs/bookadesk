module.exports = {
  forbidden: [
    // Custom rules
    {
      name: "no-dep-from-domain",
      severity: "error",
      comment: "don't allow dependencies from domain to other modules",
      from: { path: "src/domain" },
      to: { path: "src", pathNot: "src/domain" },
    },
    {
      name: "no-dep-from-usecase",
      severity: "error",
      comment: "usecase should depend only on domain",
      from: {
        path: "src/usecase",
        // Do not check test files
        pathNot: "\\.spec\\.(js|ts)$|\\.d\\.ts$",
      },
      to: { path: "src", pathNot: "src/domain|src/usecase" },
    },
...
// generated: dependency-cruiser@9.1.0 on 2020-05-13T13:01:33.526Z
